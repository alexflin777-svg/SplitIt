    ...
    <div className="space-y-6 max-w-md mx-auto overflow-x-hidden px-1 pb-24">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="p-2 rounded-xl bg-white border border-slate-200 text-slate-600 hover:bg-slate-50 transition-all shadow-xs relative"
      ...
      <div className="stitch-card p-5 bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 text-white shadow-xl relative overflow-hidden">
        <div className="flex items-center justify-between">
          <div>
        ...
        {/* Action Buttons Grid */}
        <div className="grid grid-cols-4 gap-2 pt-4 mt-4 border-t border-white/20">
          <Link
